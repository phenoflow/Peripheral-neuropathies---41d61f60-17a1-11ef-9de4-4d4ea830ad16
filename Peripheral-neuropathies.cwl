...
steps:
  ...
  peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes-amyloidosis---primary:
    run: peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes-amyloidosis---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  popliteal-peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes-amyloidosis---primary/output
  ...
  spondylopathy-peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes---primary:
    run: spondylopathy-peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: spondylopathy-peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes---primary/output
  peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes-classified---primary:
    run: peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes-classified---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  vascular-peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: peripheral-neuropathies-excluding-cranial-nerve-and-carpal-tunnel-syndromes-classified---primary/output
